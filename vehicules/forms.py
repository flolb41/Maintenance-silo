...
class VehiculeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "periodicite_revision_mois": forms.NumberInput(attrs={"class": "form-control", "min": 1}),
            "periodicite_revision_km": forms.NumberInput(attrs={"class": "form-control", "min": 1, "step": 1000}),
